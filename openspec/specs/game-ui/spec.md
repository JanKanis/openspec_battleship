...
Het systeem SHALL bij het openen een startscherm tonen met de keuze om een nieuw spel te starten of te verbinden.

#### Scenario: Nieuw spel starten
- **WHEN** de speler op "Nieuw spel" klikt
- **THEN** toont het systeem de gegenereerde game-code en wacht op een guest

#### Scenario: Verbinden als guest
- **WHEN** de speler op "Verbinden" klikt
- **THEN** toont het systeem een invoerveld voor de game-code

### Requirement: Beurt-indicatie zichtbaar tijdens schietfase
Het systeem SHALL duidelijk aangeven welke speler aan de beurt is.

#### Scenario: Eigen beurt
- **WHEN** de lokale speler aan de beurt is
- **THEN** toont het systeem "Jouw beurt" en is het tegenstander-bord klikbaar

#### Scenario: Tegenstander aan de beurt
- **WHEN** de tegenstander aan de beurt is
- **THEN** toont het systeem "Tegenstander is aan de beurt" en is het bord niet klikbaar

### Requirement: Eindscherm na afloop van het spel
Het systeem SHALL na afloop een eindscherm tonen met de uitslag en een optie om opnieuw te spelen.

#### Scenario: Gewonnen
- **WHEN** de lokale speler het spel gewonnen heeft
- **THEN** toont het systeem "Je hebt gewonnen!" met een "Opnieuw spelen" knop

#### Scenario: Verloren
- **WHEN** de lokale speler het spel verloren heeft
- **THEN** toont het systeem "Je hebt verloren." met een "Opnieuw spelen" knop

#### Scenario: Opnieuw spelen
- **WHEN** de speler op "Opnieuw spelen" klikt
